...
if(isset($_POST['simpan'])) {
    ...
    $query = "INSERT INTO properti (owner_id, nama_properti, tipe, kamar, kamar_mandi, harga, deskripsi) 
              VALUES ('$owner_id', '$nama', '$tipe', '$kamar', '$kamar_mandi', '$harga', '$deskripsi')";
...
<head>
    ...
    <style>
        ...
        .form-container { background: white; padding: 30px; border-radius: 8px; box-shadow: 0 3px 10px rgba(0,0,0,0.1); max-width: 600px; margin: 0 auto; }
        h2 { margin-top: 0; color: #d11212; }
        .form-group { margin-bottom: 15px; }
        .form-group label { display: block; font-weight: bold; margin-bottom: 5px; color: #333; }
        .form-group input, .form-group select, .form-group textarea { 
            width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box; 
        }
        .btn-simpan { background: #d11212; color: white; border: none; padding: 12px 20px; font-weight: bold; border-radius: 4px; cursor: pointer; width: 100%; font-size: 16px;}
        .btn-simpan:hover { background: #a80e0e; }
        .btn-kembali { display: inline-block; margin-bottom: 20px; color: #555; text-decoration: none; font-weight: bold; }
...
<body>
    ...
    <div class="form-container">
        <a href="dashboard_owner.php" class="btn-kembali">← Kembali ke Dashboard</a>
        ...
        <form action="" method="POST">
            ...
            <div class="form-group">
                <label>Deskripsi Properti (Fasilitas, lokasi, dll)</label>
